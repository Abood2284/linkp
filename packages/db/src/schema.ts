...
export const workspaceMetrics = pgTable(
  ...
  (metrics) => ({
    ...
    workspaceIdx: index("workspace_metrics_workspace_id_idx").on(
      metrics.workspaceId
    ),
...
export type SelectWorkspaceSocialLink =
  typeof workspaceSocialLinks.$inferSelect;
export type InsertWorkspaceSocialLink =
  typeof workspaceSocialLinks.$inferInsert;

export type SelectWorkspaceLinkAnalytic =
  typeof workspaceLinkAnalytics.$inferSelect;
export type InsertWorkspaceLinkAnalytic =
  typeof workspaceLinkAnalytics.$inferInsert;
