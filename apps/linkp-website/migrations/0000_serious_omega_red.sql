...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "aggregated_metrics_time_idx" ON "aggregated_metrics" USING btree (
    "workspace_id",
    "time_bucket",
    "bucket_start"
);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "aggregated_metrics_link_time_idx" ON "aggregated_metrics" USING btree (
    "link_id",
    "time_bucket",
    "bucket_start"
);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "link_events_timestamp_idx" ON "link_events" USING btree ("timestamp");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "link_events_workspace_idx" ON "link_events" USING btree ("workspace_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "link_events_link_idx" ON "link_events" USING btree ("link_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "link_events_visitor_idx" ON "link_events" USING btree ("workspace_id", "visitor_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workspace_links_workspace_id_idx" ON "workspace_links" USING btree ("workspace_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workspace_links_order_idx" ON "workspace_links" USING btree ("workspace_id", "order");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workspace_links_platform_idx" ON "workspace_links" USING btree ("platform");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workspace_slug_idx" ON "workspaces" USING btree ("slug");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workspace_user_id_idx" ON "workspaces" USING btree ("user_id");
--> statement-breakpoint
